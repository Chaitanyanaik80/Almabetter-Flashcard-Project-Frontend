        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
            <div className='bg-white dark:bg-gray-800 p-7 my-2 drop-shadow-md rounded-lg'>
              <div className="flex flex-wrap">
                <div className=" w-96 px-3">
                  ...
                  <label className=" tracking-wide text-black-500 font-bold "
                    htmlFor="Create_Group" >
                    Create Group*
                  </label>
                  <Field className="appearance-none block w-full my-2 bg-orange-100 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="Create_Group"
                    name='Create_Group'
                    type="text"
                  ...
                  if image is not present its shows image uploading button */}
                  {
                    values.uploadimage ? (<div className='flex '> <img className='h-16 mt-2' src={values.uploadimage} alt="" /> <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue("uploadimage", '')} /> </div>) :
                      (<label htmlFor='uploadimage'
                        className="w-44 h-[38px]  cursor-pointer px-3 mx-3 mt-8 py-1 bg-white-200 border-gray-200 flex  items-center justify-center  rounded" >
                        <MdUploadFile
                          className=" text-[2em] text-orange-600" />
                        <span
                ...
                <div className="w-full my-2 px-3">
                  <label className=" tracking-wide  text-black-800 font-bold "
                    htmlFor="description">
                    Add description
                  </label>
                  ...
                  <Field
                    ...
                    name='description'
                    rows="3"
                    className="block my-2 p-2.5 w-3/4 text-sm text-gray-700  rounded  border-gray-200  focus:border-gray-500 focus:bg-white bg-orange-100  "
              ...
              render={(arrayHelpers) => (
                <div className='bg-white dark:bg-gray-800 p-7 my-4 drop-shadow-md rounded-lg'>
                    ...
                    values.term.map((term, index) => (
                      <div key={index} className='my-5 flex flex-wrap' >
                        ...
                        <div className=" w-[410px] px-3">
                          ...
                          <input
                            ref={addRefs}
                            className="appearance-none block w-full my-2 bg-orange-100 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        ...
                        <div className='flex'>
                          ...
                          if image is not present its shows image uploading button */}
                          {
                            term.term_uploadimage ? ((<div className='flex  '> <img className='h-16 mt-2  max-w-[12rem]' src={term.term_uploadimage} alt="" /> <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue(`term.${index}.term_uploadimage`, '')} /> </div>)) :
                              (<label htmlFor={`term.${index}.term_uploadimage`} className="w-44 h-[38px] cursor-pointer px-3 mx-3 mt-8 py-1 bg-white-200 border-gray-200 flex  items-center justify-center  rounded" >
                                <span className='text-orange-600 font-bold'>Select Image</span>
                              </label>)
                          }
                          {/* it's a component to show error massage of validation */}
                          <ErrorMessage
                          ...
                          <div>
                            ...
                            <TbEdit className='text-[1.8em] text-orange-600 m-2 cursor-pointer hover:text-orange-900'
                  ...
                  <div onClick={() => arrayHelpers.insert(values.term.length + 1, {
                    ...
                    Enter_Definition: "",
                    term_uploadimage: '',
                  })} className="my-5 cursor-pointer w-24 mx-5 text-green-800">
            ...
            <div className="h-28 flex  items-center justify-center">
              ...
              <button type='submit'
                className="bg-orange-600 hover:bg-orange-700 font-bold py-2 px-14 rounded text-white bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-orange-300 dark:focus:-orange-800 shadow-lg ">
                Create
              </button>
            </div>
          </Form>
