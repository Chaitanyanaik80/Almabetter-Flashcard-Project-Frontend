...
import card_logo from './Images/AL.jpg';
    ...
    <>
      ...
      {flashCard.length === 0 ? (
        <div className='flex flex-col items-center justify-center h-[80vh]'>
          ...
          <Link to='/'>
            <button className='rounded-xl hover:bg-orange-800 bg-orange-700 px-4 p-2 m-2 text-center text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium  py-2.5 mr-2 mb-2 '>
